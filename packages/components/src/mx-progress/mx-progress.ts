...
export class MXProgress extends LitElement {
  static styles = css`
    :host {
  ...
  private get actualStatus(): ProgressStatus {
  ...
  private renderDashboardProgress() {
    ...
    switch (this.gapPosition) {
      case 'top': gapAngle = 0; break;
      case 'right': gapAngle = 90; break;
      case 'bottom': gapAngle = 180; break;
      case 'left': gapAngle = -90; break;
    }
