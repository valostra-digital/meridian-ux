 ...
 */
export function generatePalette(color: string): string[] {
 ...
 */
export function getColorVar(colorName: string, shade: number): string {
 ...
 */
export function generateNeutralVars(): Record<string, string> {
  return {
    // Text colors
