 ...
 * ```
 */
let MXDrawer = class MXDrawer extends LitElement {
    constructor() {
        super(...arguments);
        this.open = false;
        this.title = '';
...
], MXDrawer.prototype, "open", void 0);
__decorate([
    property({ type: String })
], MXDrawer.prototype, "title", void 0);
__decorate([
    property({ type: String })
], MXDrawer.prototype, "placement", void 0);
__decorate([
    property({ type: Boolean })
], MXDrawer.prototype, "closable", void 0);
__decorate([
    property({ type: Boolean })
], MXDrawer.prototype, "mask", void 0);
__decorate([
    property({ type: Boolean, attribute: 'mask-closable' })
], MXDrawer.prototype, "maskClosable", void 0);
__decorate([
    property({ type: Number })
], MXDrawer.prototype, "width", void 0);
__decorate([
    property({ type: Number })
], MXDrawer.prototype, "height", void 0);
__decorate([
    property({ type: Number, attribute: 'z-index' })
], MXDrawer.prototype, "zIndex", void 0);
__decorate([
    property({ type: String })
], MXDrawer.prototype, "size", void 0);
__decorate([
    state()
], MXDrawer.prototype, "animating", void 0);
MXDrawer = __decorate([
    customElement('mx-drawer')
], MXDrawer);
export { MXDrawer };
//# sourceMappingURL=mx-drawer.js.map