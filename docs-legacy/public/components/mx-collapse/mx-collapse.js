 ...
 * ```
 */
let MXCollapse = class MXCollapse extends LitElement {
    constructor() {
        super(...arguments);
        this.activeKey = '';
    ...
    connectedCallback() {
        ...
        this.addEventListener('panel-toggle', this.handlePanelToggle);
    }
...
], MXCollapse.prototype, "activeKey", void 0);
__decorate([
    property({ type: Boolean })
], MXCollapse.prototype, "accordion", void 0);
__decorate([
    property({ type: Boolean })
], MXCollapse.prototype, "bordered", void 0);
__decorate([
    property({ type: String, attribute: 'expand-icon-position' })
], MXCollapse.prototype, "expandIconPosition", void 0);
__decorate([
    property({ type: Boolean })
], MXCollapse.prototype, "ghost", void 0);
MXCollapse = __decorate([
    customElement('mx-collapse')
], MXCollapse);
export { MXCollapse };
//# sourceMappingURL=mx-collapse.js.map