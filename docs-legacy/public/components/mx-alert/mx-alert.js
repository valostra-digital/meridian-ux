 ...
 * ```
 */
let MXAlert = class MXAlert extends LitElement {
    constructor() {
        super(...arguments);
        /**
         * Type of alert
...
], MXAlert.prototype, "type", void 0);
__decorate([
    property({ type: String })
], MXAlert.prototype, "message", void 0);
__decorate([
    property({ type: String })
], MXAlert.prototype, "description", void 0);
__decorate([
    property({ type: Boolean })
], MXAlert.prototype, "closable", void 0);
__decorate([
    property({ type: Boolean, attribute: 'show-icon' })
], MXAlert.prototype, "showIcon", void 0);
__decorate([
    property({ type: Boolean })
], MXAlert.prototype, "banner", void 0);
__decorate([
    property({ type: String, attribute: 'close-text' })
], MXAlert.prototype, "closeText", void 0);
__decorate([
    state()
], MXAlert.prototype, "visible", void 0);
__decorate([
    state()
], MXAlert.prototype, "closing", void 0);
MXAlert = __decorate([
    customElement('mx-alert')
], MXAlert);
export { MXAlert };
//# sourceMappingURL=mx-alert.js.map