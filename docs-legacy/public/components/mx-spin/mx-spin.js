 ...
 * ```
 */
let MXSpin = class MXSpin extends LitElement {
    constructor() {
        super(...arguments);
        /**
...
], MXSpin.prototype, "spinning", void 0);
__decorate([
    property({ type: String, reflect: true })
], MXSpin.prototype, "size", void 0);
__decorate([
    property({ type: String })
], MXSpin.prototype, "tip", void 0);
__decorate([
    property({ type: Number })
], MXSpin.prototype, "delay", void 0);
MXSpin = __decorate([
    customElement('mx-spin')
], MXSpin);
export { MXSpin };
//# sourceMappingURL=mx-spin.js.map