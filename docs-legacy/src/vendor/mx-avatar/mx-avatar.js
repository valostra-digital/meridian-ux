 ...
 * ```
 */
let MXAvatar = class MXAvatar extends LitElement {
    constructor() {
        super(...arguments);
        this.shape = 'circle';
        this.size = 'default';
...
], MXAvatar.prototype, "shape", void 0);
__decorate([
    property({ type: String })
], MXAvatar.prototype, "size", void 0);
__decorate([
    property({ type: String })
], MXAvatar.prototype, "src", void 0);
__decorate([
    property({ type: String })
], MXAvatar.prototype, "srcset", void 0);
__decorate([
    property({ type: String })
], MXAvatar.prototype, "alt", void 0);
__decorate([
    property({ type: String })
], MXAvatar.prototype, "icon", void 0);
__decorate([
    property({ type: Number })
], MXAvatar.prototype, "gap", void 0);
__decorate([
    state()
], MXAvatar.prototype, "scale", void 0);
__decorate([
    state()
], MXAvatar.prototype, "imageError", void 0);
MXAvatar = __decorate([
    customElement('mx-avatar')
], MXAvatar);
export { MXAvatar };
//# sourceMappingURL=mx-avatar.js.map