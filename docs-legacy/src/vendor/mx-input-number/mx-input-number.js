 ...
 * ```
 */
let MXInputNumber = class MXInputNumber extends LitElement {
    constructor() {
        super(...arguments);
        this.size = 'middle';
        this.status = '';
...
], MXInputNumber.prototype, "size", void 0);
__decorate([
    property({ type: String })
], MXInputNumber.prototype, "status", void 0);
__decorate([
    property({ type: String })
], MXInputNumber.prototype, "variant", void 0);
__decorate([
    property({ type: Number })
], MXInputNumber.prototype, "value", void 0);
__decorate([
    property({ type: Number, attribute: 'default-value' })
], MXInputNumber.prototype, "defaultValue", void 0);
__decorate([
    property({ type: Number })
], MXInputNumber.prototype, "min", void 0);
__decorate([
    property({ type: Number })
], MXInputNumber.prototype, "max", void 0);
__decorate([
    property({ type: Number })
], MXInputNumber.prototype, "step", void 0);
__decorate([
    property({ type: Number })
], MXInputNumber.prototype, "precision", void 0);
__decorate([
    property({ type: Boolean })
], MXInputNumber.prototype, "disabled", void 0);
__decorate([
    property({ type: Boolean })
], MXInputNumber.prototype, "controls", void 0);
__decorate([
    property({ type: String })
], MXInputNumber.prototype, "placeholder", void 0);
__decorate([
    property({ type: Boolean })
], MXInputNumber.prototype, "keyboard", void 0);
__decorate([
    property({ type: String, attribute: 'controls-position' })
], MXInputNumber.prototype, "controlsPosition", void 0);
__decorate([
    query('input')
], MXInputNumber.prototype, "inputElement", void 0);
__decorate([
    state()
], MXInputNumber.prototype, "focused", void 0);
__decorate([
    state()
], MXInputNumber.prototype, "internalValue", void 0);
MXInputNumber = __decorate([
    customElement('mx-input-number')
], MXInputNumber);
export { MXInputNumber };
//# sourceMappingURL=mx-input-number.js.map