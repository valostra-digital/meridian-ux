 ...
 * ```
 */
let MXPopover = class MXPopover extends LitElement {
    constructor() {
        super(...arguments);
        this.title = '';
        this.content = '';
...
], MXPopover.prototype, "title", void 0);
__decorate([
    property({ type: String })
], MXPopover.prototype, "content", void 0);
__decorate([
    property({ type: String })
], MXPopover.prototype, "placement", void 0);
__decorate([
    property({ type: String })
], MXPopover.prototype, "trigger", void 0);
__decorate([
    property({ type: Boolean })
], MXPopover.prototype, "visible", void 0);
__decorate([
    property({ type: Boolean })
], MXPopover.prototype, "arrow", void 0);
__decorate([
    property({ type: Number, attribute: 'mouse-enter-delay' })
], MXPopover.prototype, "mouseEnterDelay", void 0);
__decorate([
    property({ type: Number, attribute: 'mouse-leave-delay' })
], MXPopover.prototype, "mouseLeaveDelay", void 0);
__decorate([
    state()
], MXPopover.prototype, "internalVisible", void 0);
__decorate([
    state()
], MXPopover.prototype, "position", void 0);
__decorate([
    query('.mx-popover-trigger')
], MXPopover.prototype, "triggerElement", void 0);
__decorate([
    query('.mx-popover-content')
], MXPopover.prototype, "contentElement", void 0);
MXPopover = __decorate([
    customElement('mx-popover')
], MXPopover);
export { MXPopover };
//# sourceMappingURL=mx-popover.js.map