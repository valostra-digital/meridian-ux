 ...
 * ```
 */
let MXRadio = class MXRadio extends LitElement {
    constructor() {
        super(...arguments);
        this.checked = false;
        this.disabled = false;
    ...
    uncheckOthers() {
        ...
        const radios = document.querySelectorAll(`mx-radio[name="${this.name}"]`);
...
], MXRadio.prototype, "checked", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], MXRadio.prototype, "disabled", void 0);
__decorate([
    property({ type: String })
], MXRadio.prototype, "value", void 0);
__decorate([
    property({ type: String })
], MXRadio.prototype, "name", void 0);
MXRadio = __decorate([
    customElement('mx-radio')
], MXRadio);
export { MXRadio };
//# sourceMappingURL=mx-radio.js.map