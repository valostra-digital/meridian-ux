 ...
 */
let MXSubMenu = class MXSubMenu extends LitElement {
    constructor() {
        super(...arguments);
        /**
...
], MXSubMenu.prototype, "key", void 0);
__decorate([
    property({ type: String })
], MXSubMenu.prototype, "label", void 0);
__decorate([
    property({ type: Boolean })
], MXSubMenu.prototype, "disabled", void 0);
__decorate([
    property({ type: Boolean, attribute: 'is-open' })
], MXSubMenu.prototype, "isOpen", void 0);
__decorate([
    property({ type: String })
], MXSubMenu.prototype, "mode", void 0);
__decorate([
    property({ type: String })
], MXSubMenu.prototype, "theme", void 0);
__decorate([
    property({ type: Number })
], MXSubMenu.prototype, "level", void 0);
__decorate([
    property({ type: Boolean, attribute: 'inline-collapsed' })
], MXSubMenu.prototype, "inlineCollapsed", void 0);
__decorate([
    state()
], MXSubMenu.prototype, "popupVisible", void 0);
MXSubMenu = __decorate([
    customElement('mx-sub-menu')
], MXSubMenu);
export { MXSubMenu };
//# sourceMappingURL=mx-sub-menu.js.map