 ...
 * ```
 */
let MXTypography = class MXTypography extends LitElement {
    constructor() {
        super(...arguments);
        /**
         * Component variant
...
], MXTypography.prototype, "variant", void 0);
__decorate([
    property({ type: Number })
], MXTypography.prototype, "level", void 0);
__decorate([
    property({ type: String })
], MXTypography.prototype, "type", void 0);
__decorate([
    property({ type: Boolean })
], MXTypography.prototype, "disabled", void 0);
__decorate([
    property({ type: Boolean })
], MXTypography.prototype, "mark", void 0);
__decorate([
    property({ type: Boolean })
], MXTypography.prototype, "code", void 0);
__decorate([
    property({ type: Boolean })
], MXTypography.prototype, "keyboard", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], MXTypography.prototype, "underline", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], MXTypography.prototype, "delete", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], MXTypography.prototype, "strong", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], MXTypography.prototype, "italic", void 0);
MXTypography = __decorate([
    customElement('mx-typography')
], MXTypography);
export { MXTypography };
//# sourceMappingURL=mx-typography.js.map