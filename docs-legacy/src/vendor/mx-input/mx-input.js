 ...
 * ```
 */
let MXInput = class MXInput extends LitElement {
    constructor() {
        super(...arguments);
...
], MXInput.prototype, "variant", void 0);
__decorate([
    property({ type: String })
], MXInput.prototype, "size", void 0);
__decorate([
    property({ type: String })
], MXInput.prototype, "status", void 0);
__decorate([
    property({ type: String })
], MXInput.prototype, "value", void 0);
__decorate([
    property({ type: String, attribute: 'default-value' })
], MXInput.prototype, "defaultValue", void 0);
__decorate([
    property({ type: String })
], MXInput.prototype, "placeholder", void 0);
__decorate([
    property({ type: Boolean })
], MXInput.prototype, "disabled", void 0);
__decorate([
    property({ type: Boolean, attribute: 'allow-clear' })
], MXInput.prototype, "allowClear", void 0);
__decorate([
    property({ type: Boolean, attribute: 'show-count' })
], MXInput.prototype, "showCount", void 0);
__decorate([
    property({ type: Number, attribute: 'max-length' })
], MXInput.prototype, "maxLength", void 0);
__decorate([
    property({ type: String })
], MXInput.prototype, "type", void 0);
__decorate([
    property({ type: String })
], MXInput.prototype, "name", void 0);
__decorate([
    property({ type: String })
], MXInput.prototype, "autocomplete", void 0);
__decorate([
    query('input')
], MXInput.prototype, "inputElement", void 0);
__decorate([
    state()
], MXInput.prototype, "focused", void 0);
__decorate([
    state()
], MXInput.prototype, "internalValue", void 0);
MXInput = __decorate([
    customElement('mx-input')
], MXInput);
export { MXInput };
//# sourceMappingURL=mx-input.js.map