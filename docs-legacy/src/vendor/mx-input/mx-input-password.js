 ...
 * ```
 */
let MXInputPassword = class MXInputPassword extends LitElement {
    constructor() {
        super(...arguments);
...
], MXInputPassword.prototype, "variant", void 0);
__decorate([
    property({ type: String })
], MXInputPassword.prototype, "size", void 0);
__decorate([
    property({ type: String })
], MXInputPassword.prototype, "status", void 0);
__decorate([
    property({ type: String })
], MXInputPassword.prototype, "value", void 0);
__decorate([
    property({ type: String })
], MXInputPassword.prototype, "placeholder", void 0);
__decorate([
    property({ type: Boolean })
], MXInputPassword.prototype, "disabled", void 0);
__decorate([
    property({ type: Boolean, attribute: 'visibility-toggle' })
], MXInputPassword.prototype, "visibilityToggle", void 0);
__decorate([
    state()
], MXInputPassword.prototype, "visible", void 0);
__decorate([
    query('input')
], MXInputPassword.prototype, "inputElement", void 0);
MXInputPassword = __decorate([
    customElement('mx-input-password')
], MXInputPassword);
export { MXInputPassword };
//# sourceMappingURL=mx-input-password.js.map